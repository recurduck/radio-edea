...
export default function TrackPreview({ track, displayList, favorite=false}) {
    ...
    return (
        <div className={`track-prev ${displayList ? 'list ' : 'tile '}`}>
            ...
            {favorite && <TrackToggleLike track={track}/>}
        </div>
    )
}